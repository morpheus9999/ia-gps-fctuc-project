...
@date    2009-02-09
@version $Id: generateTripsXml.py 8236 2010-02-10 11:16:41Z behrisch $
...
def main(options):
    ...
    print >> fouttrips, """<!-- generated on %s by $Id: generateTripsXml.py 8236 2010-02-10 11:16:41Z behrisch $ -->
